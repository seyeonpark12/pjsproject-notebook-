...
public class FormController {
	...
	public ModelAndView read1(@RequestParam String name,@RequestParam int age,@RequestParam(value="msg",defaultValue = "HappyDay") String msg) {
		...
		mview.setViewName("process1");   //주소값설정
